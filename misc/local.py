...
def create_3dcnn(input_shape, nb_classes):
    ...
    # 2nd layer group
    model.add(Conv3D(32, kernel_size=(3, 3, 3), activation='softmax', padding='same', name='conv2'))
    model.add(MaxPooling3D(pool_size=(3, 3, 3), strides=(2, 2, 2), padding='valid', name='pool2'))
    model.add(Dropout(0.25))

    # 3rd layer group

    model.add(Conv3D(64, kernel_size=(3, 3, 3), activation='relu', padding='same', name='conv3a'))
    model.add(Conv3D(64, kernel_size=(3, 3, 3), activation='softmax', padding='same', name='conv3b'))

    #model.add(Conv3D(256, kernel_size=(3, 3, 3), activation='relu', padding='same', name='conv3b', strides=(1, 1, 1)))
    model.add(MaxPooling3D(pool_size=(3, 3, 3), strides=(2, 2, 2), padding='valid', name='pool3'))
    model.add(Dropout(0.25))
    ...
    # FC layers group
    model.add(Dense(512, activation='sigmoid', name='fc6'))
    model.add(Dropout(.5))
    model.add(Dense(512, activation='sigmoid', name='fc7'))
    model.add(Dropout(.5))
