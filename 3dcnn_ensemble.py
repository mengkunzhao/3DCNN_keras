...
def main():
    ...
    history = model.fit([X_train_c, X_train_d], Y_train_c,validation_data={'input_color': X_test_c, 'input_depth': X_test_d}, batch_size=args.batch,nb_epoch=args.epoch, verbose=1, shuffle=True , callbacks=callbacks_list)
